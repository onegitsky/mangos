return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>d", "<cmd>Telescope live_grep<CR>", { desc = "Fuzzy search string in cwd" })
		vim.keymap.set("n", "<leader>s", "<cmd>Telescope oldfiles<CR>", { desc = "Fuzzy find recent files" })
